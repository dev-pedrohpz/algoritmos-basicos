# Crie uma função que receba três notas como parâmetros e retorne a média.
# No programa principal, use uma variável global para armazenar essa média 
# e exiba se o aluno está aprovado (média >= 7) ou reprovado.
